...
export default function XVerifiedFollowers({ templateId = 2, templateName = 'X Verified Followers' }) {
  const [showMobileEdit, setShowMobileEdit] = useState(false);
  const [config, setConfig] = useState({
    verifiedCount: 850,
    totalCount: 1000,
    duration: 2,
    animationType: 'count-up', // count-up, fade-in, slide-in
    showPercentage: true,
    showConfetti: true, // Enable/disable confetti
    animationStyle: 'style-1', // Animation style preset
    // Twitter/X colors
    colors: {
      background: 'rgb(22, 24, 29)',
      border: 'rgb(50, 54, 57)',
      title: 'rgb(183, 186, 189)',
      verifiedIcon: 'rgb(30, 156, 241)',
      numbers: 'rgb(230, 233, 234)',
    },
    // Export settings
    export: {
      width: 1920,
