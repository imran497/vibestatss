...
export default function LaunchAnnouncement({ templateId = 6, templateName = 'Launch Announcement' }) {
  const [showMobileEdit, setShowMobileEdit] = useState(false);
  const [config, setConfig] = useState({
    product: {
      name: 'VibeStatss',
      logo: 'https://www.google.com/s2/favicons?domain=vibestatss.com&sz=128',
      link: 'https://vibestatss.com',
      customLogo: false
    },
    platform: {
      name: 'Product Hunt',
    ...
    type: 'launching', // launching or featuring
    backgroundType: 'image', // 'image' or 'gradient'
    backgroundImage: 1, // 1-10 for abstract backgrounds
    backgroundGradient: {
      color1: '#667eea',
      color2: '#764ba2',
      direction: 'to bottom right' // CSS gradient direction
    },
    ...
    font: 'var(--font-merriweather), serif',
    fontWeight: '700',
  ...
  return (
    <main className={`flex flex-col lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden ${outfit.className}`} suppressHydrationWarning>
      {/* Mobile Menu */}
      <MobileMenu />
