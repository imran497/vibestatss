...
export default function XAnalytics({ templateId = 3, templateName = 'X Analytics' }) {
  const [showMobileEdit, setShowMobileEdit] = useState(false);
  const [config, setConfig] = useState({
    verifiedFollowers: 850,
    totalFollowers: 1200,
    impressions: 3176,
    engagements: 422,
    likes: 155,
    ...
    newFollowers: 24,
    unfollows: 9,
    duration: 10, // Total video duration
    animationDuration: 2, // Counter animation duration
    showConfetti: false,
    confettiColors: ['#FFD700', '#FFA500'], // Gold colors by default
    colors: {
      background: '#000000',
      cardBackground: 'rgb(22, 24, 29)',
      cardBorder: 'rgb(50, 54, 57)',
      title: 'rgb(183, 186, 189)',
      text: 'rgb(230, 233, 234)',
    },
    export: {
      width: 560, // Based on card size 209.5 × 96.5 (rounded to even)
      height: 640, // Preview aspect ratio (export will be more compact)
      fps: 60,
      duration: 3
    },
  });
